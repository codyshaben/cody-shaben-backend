...
Repository.create(user_id: 1, title: "LineFinder Frontend", description: "Vanilla JavaScript frontend connecting to the Google Maps api to find backcountry ski trails.", technology: "Javascript", link: "https://github.com/codyshaben/backcountry-front-end")
